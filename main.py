...
def main() -> None:
    print("1/10 Download / ensure raw data")
    download_raw_data()

    print("2/10 Load tables")
    ...
    print("3/10 Exploratory data analysis")
    run_eda()

    print("4/10 Monthly sent vs participated")
    run_monthly_training_analysis()

    print("5/10 Share sent vs not sent to training")
    run_sent_share_analysis()

    print("6/10 Completion vs dropout among participants")
    run_completion_share_analysis()

    print("7/10 Patterns and interactions")
    run_insights_analysis()

    print("8/10 Unemployment length vs training")
    run_duration_impact_analysis()

    print("9/10 Training status of unemployed people")
    run_training_status_analysis()

    print("10/10 Training-status facet charts")
